...
export function SimpleWork() {
  const features = [
    ...
    },
    {
      ...
      description: 'Если ночью завис отчёт — не нужно искать виноватых. Наши специалисты отвечают в чате, по телефону и почте за пару минут даже в выходные и праздники.',
      iconPosition: 'left',
      renderIcon: (isBlue: boolean) => {
